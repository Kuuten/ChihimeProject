...
//
//--------------------------------------------------------------
public class EventScene11 : EventScene
{
    public override IEnumerator PlayEvent()
    {
        Debug.Log("***イベント11：ハクメン戦闘前を開始します***");
        ...
        //  ボスを生成＆指定座標へ移動
        StartCoroutine(CreateBossAndMove(BossType.Hakumen, new Vector2(-1, 5.5f)));
        ...
        Debug.Log("***イベント11：ハクメン戦闘前を完了しました***");
    }
}
