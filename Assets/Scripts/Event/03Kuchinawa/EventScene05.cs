...
//
//--------------------------------------------------------------
public class EventScene05 : EventScene
{
    public override IEnumerator PlayEvent()
    {
        Debug.Log("***イベント05：クチナワ戦闘前を開始します***");
        ...
        //  ボスを生成＆指定座標へ移動
        StartCoroutine(CreateBossAndMove(BossType.Kuchinawa, new Vector2(-1, 5.5f)));
        ...
        Debug.Log("***イベント05：クチナワ戦闘前を完了しました***");
    }
}
